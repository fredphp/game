...
type ActivityConfig struct {
	...
	Type        string    `json:"type" gorm:"size:30;not null"` // gacha/war/growth/festival/guild
...
type City struct {
	...
	MaxSoldiers int   `json:"maxSoldiers"`
}

// March 行军信息 (从map-service获取)
type March struct {
	ID        int64  `json:"id"`
